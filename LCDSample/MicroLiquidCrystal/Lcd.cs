...
/*       
        ...
        public void ModeForwardStatic()
        {

            SendCommand(0x18 | 0x06);
        ...
        public void Print(int row, int column, string text)
        {
        ...
        public void Print(Position row, Position column, string text)
        {
        ...
        public static string FillRow(string text)
        {
            ...
            string spaces = new string((char)32, 20 - len);
