function MapEditor(engine) {
    ...
    var camera = new BABYLON.ArcRotateCamera("Camera", -Math.PI / 3, 1.2, 50, new BABYLON.Vector3.Zero(), scene);
    ...
    window.addEventListener("click", function (evt) {
        ...
        var pickResult = scene.pick(evt.clientX * scale, evt.clientY * scale);
